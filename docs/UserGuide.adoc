...
* Upon editing the salary/overtime hours/overtime rate/pay deductibles, net salary would be computed via this formula :
"Salary + (Overtime Hours * Overtime Rate) - Pay Deductibles" and displayed.
****
