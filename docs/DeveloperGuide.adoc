 ...
 * *       | HR User  | Have different authorization settings for people                                                               | Employees can only use commands they should be able to                    |
 ...
 * *       | HR User  | Set a salary for an employee                                                                                   | Maintain a record of the employee’s payroll                               |
 ...
 * *       | Manager  | Set work ratings & feedback for certain staff                                                                  | Evaluate the employees under me                                           |
 * *       | Manager  | Update work ratings & feedback for certain staff                                                               | Edit the employee’s rating under me                                       |
 * *       | Manager  | Sort by ratings                                                                                                | Reward the highly rated performers and identify the weaker ones           |
 * *       | Manager  | Search by employee tags                                                                                        | Find the people I require more conveniently                               |
 *        | Manager  | Receive notification to rate staff                                                                             | Remember to rate my staff and give timely feedback                        |
 *        | Manager  | Receive notification of staff whose rating falls below average for 3 months consecutively under my supervision | Better manage my employees and find out if they need any help             |
|=======================================================================
...
1. Employee logs into SSENISUB
2. Employee inputs keyword to view his own ratings
...
[discrete]
=== Use case: edit an employee information

*MSS*

1. HR staff logs in to SSENISUB
2. HR staff searches for the staff to edit and selects it
3. HR staff makes the necessary changes to the employee
...
*Extensions*
[none]
* 2a.  No employees are being displayed by SSENISUB
+
Use case ends
...
1. Employee logs in to SSENISUB
2. Employee inputs the keyword to search followed by certain keywords pertaining to the employee.
3. SSENISUB displays the list of employees that matches the keywords supplied.
+
Use case ends

*Extensions*
[none]
* 3a. SSENISUB shows no employees with the matching keywords
+
Use case ends
...
1. HR staff logs in to SSENISUB
2. HR staff adds the Employee details into SSENISUB
...
* 2b. Employee details already exists, receives a warning
+
Use case ends
[none]
** 2c. User does not have authorization to add Employees, receives warning
+
...
[discrete]
=== Use case: review employee

*MSS*

1. Manager logs in to SSENISUB
2. Manager requests to look for Employee
3. SSENISUB shows a list of Employees
4. Manager requests to update review of a particular Employee
5. SSENISUB updates review of Employee
+
Use case ends
...
3. HR inputs command to remove the employee
4. SSENISUB confirms with the HR staff before removing the employee
5. SSENISUB removes the employee and displays a success message
+
Use case ends

*Extensions*
[none]
* 3a. The employee cannot be found
+
Use case ends

[discrete]
=== Use case: set employees’ feedback

*MSS*

1. Manager logs into SSENISUB
2. Manager searches for an employee
3. SSENISUB shows the user the employee and the manager selects the employee
4. Manager enters feedback for the employee and submits the feedback
...
[discrete]
=== Use case: sort ratings of employees

*MSS*

1. Manager logs into SSENISUB
2. Manager displays all employees under him/her
3. Manager inputs the command to sort the employees by their ratings
4. SSENISUB sorts the employees by the user’s preference and displays
+
Use case ends

*Extensions*
[none]
* 2a. SSENISUB does not show any employees under the user
+
Use case ends
[none]
...
.  Should be able to hold up to 100,000 persons without a noticeable sluggishness in performance for typical usage.
