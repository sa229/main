...
<<<<<<< HEAD
By: `T13-2`      Since: `Jun 2016`      Licence: `MIT`
=======
By: `Team T13-2`      Since: `Oct 2018`      Licence: `MIT`
>>>>>>> 6e9d5a4e4c9736e2507f97bf5f1885adb6182193
...
[NOTE]
This command differs from the and and edit command, because users cannot simply add an employee with a rating through
