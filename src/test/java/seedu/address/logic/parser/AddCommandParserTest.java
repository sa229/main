...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + DEPARTMENT_DESC_BOB + MANAGER_DESC_BOB
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + DEPARTMENT_DESC_BOB + MANAGER_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + INVALID_DEPARTMENT_DESC + MANAGER_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Department.MESSAGE_CONSTRAINTS);

        // invalid manager
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                        + DEPARTMENT_DESC_BOB + INVALID_MANAGER_DESC + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Manager.MESSAGE_CONSTRAINTS);

        // invalid tag
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + DEPARTMENT_DESC_BOB + MANAGER_DESC_BOB + INVALID_TAG_DESC + VALID_TAG_FRIEND,
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DEPARTMENT_DESC_BOB + MANAGER_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
