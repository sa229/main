...
public class DeleteCommandSystemTest extends SsenisubSystemTest {
    ...
    public void delete() {
        ...
        Index outOfBoundsIndex = Index.fromOneBased(
                getModel().getSsenisub().getPersonList().size() + 1);
     ...
     * {@code SsenisubSystemTest#assertApplicationDisplaysExpected(String, String, Model)}.
