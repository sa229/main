...
import seedu.address.storage.SsenisubStorage;
import seedu.address.storage.Storage;
import seedu.address.storage.StorageManager;
import seedu.address.storage.UserPrefsStorage;
import seedu.address.storage.XmlSsenisubStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing SSENISUB ]===========================");
        super.init();
    ...
    private Model initModelManager(Storage storage, UserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. Will be starting with an empty SSENISUB");
            initialData = new Ssenisub();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting SSENISUB " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping SSENISUB ] =============================");
        ui.stop();
        try {
