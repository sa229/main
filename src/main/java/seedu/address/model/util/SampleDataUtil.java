        ...
        return new Person[] {
            new Person(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new Address("Blk 30 Geylang Street 29, #06-40"), new Rating("10"), new Department("Accounting"),
                    ...
                    new PayDeductibles("200"), new Feedback("You have alot of potential."), getTagSet("friends")),
            ...
            new Person(new Name("David Li"), new Phone("91031282"), new Email("lidavid@example.com"),
                new Address("Blk 436 Serangoon Gardens Street 26, #16-43"), new Rating("8"),
                    ...
                    new Feedback("Congratulations for hitting your KPI! Strive foe greatness."), getTagSet("family")),
